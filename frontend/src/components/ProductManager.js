...
// channelType is "stand" or "parcel", channelId is the id
function ProductManager({ channelType, channelId }) {
  ...
  return (
    <div style={{ background: '#fafafa', padding: '15px', borderRadius: '8px', marginTop: '10px' }}>
      ...
      {products.map(p => (
        <div key={p.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px', borderBottom: '1px solid #eee' }}>
          <div>
